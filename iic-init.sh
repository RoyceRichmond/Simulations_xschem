...
#this line will dump all the simulation data to the Raw folder

echo "set netlist_dir $custom_dir/Raw" >> $HOME/.xschem/xschemrc

#this will dump on a new folder named simulation on the same folder the schematics file is stored
