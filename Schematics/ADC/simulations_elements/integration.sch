...
N 440 -400 460 -400 {
lab=#net1}
C {Schematics/ADC/sw/sw.sym} 220 -1070 0 0 {name=x3}
...
C {Schematics/ADC/c_array/c_array.sym} 270 -770 0 0 {name=x1 @value=1
+ MF_P=128}
C {devices/vsource.sym} 170 -500 0 0 {name=v1 value="1.8"}
C {devices/gnd.sym} 170 -380 0 0 {name=l1 lab=GND}
C {Schematics/ADC/inverter_array/inverter_array.sym} 20 -460 0 0 {name=x2}
