...
B 2 370 -830 1170 -430 {flags=graph
y1=-1.07159
y2=2.38442
ypos1=0
ypos2=2
...
C {devices/vsource.sym} -30 -30 0 0 {name=v2 value="SIN 1 0.6 500 0 0"}
C {devices/launcher.sym} 780 40 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/sim_sw_sinewave.raw tran"
}
