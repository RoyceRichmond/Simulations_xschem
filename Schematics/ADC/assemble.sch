...
C {Downloads/ADC/sw/sw.sym} 270 -880 0 0 {name=x6}
...
C {Downloads/ADC/sw/sw.sym} 840 -810 0 0 {name=x9}
...
C {Downloads/ADC/inverter_array/inverter_array.sym} 270 -350 0 0 {name=x10}
...
C {Downloads/ADC/inverter_array/inverter_array.sym} 880 -340 0 0 {name=x12}
...
C {Downloads/ADC/c_array/c_array.sym} 420 -730 0 0 {name=x13 @value=1
+ MF_F=83}
C {Downloads/ADC/c_array/c_array.sym} 1030 -700 0 0 {name=x14 @value=1
+ MF_F=83}
