...
C {Schematics/ADC/c_array/c_array.sym} 1030 -700 0 0 {name=x1 @value=1}
C {Schematics/ADC/sw/sw.sym} 270 -880 0 0 {name=x3}
C {Schematics/ADC/inverter_array/inverter_array.sym} 880 -340 0 0 {name=x4}
C {Schematics/ADC/sw/sw.sym} 840 -810 0 0 {name=x2}
C {Schematics/ADC/inverter_array/inverter_array.sym} 270 -350 0 0 {name=x6}
C {Schematics/ADC/c_array/c_array.sym} 420 -730 0 0 {name=x5 @value=1}
